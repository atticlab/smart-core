...
class ManageAssetOpFrame : public OperationFrame
{
  ...
  public:
    ManageAssetOpFrame(Operation const& op, OperationResult& res, OperationFee* fee,
...
private:
	bool manageAsset(Application& app, LedgerDelta& delta, LedgerManager& ledgerManager);
};
}
